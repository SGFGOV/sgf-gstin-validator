...
function getInfo(gstin) {
  ...
  var info_msg = "The GSTIN " + gstin + " is entity #" +
    parseInt(gstin.slice(12, 13), 36) + " belonging to " +
      panTypes.find(function(o) { 
        return o.code === gstin[5] }).pan_type + " whose PAN is " +
      gstin.slice(2, 12) + " registered in " + state.state_name + " (" +
